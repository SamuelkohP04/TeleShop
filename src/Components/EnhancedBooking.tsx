...
const SERVICES = [
  {
    ...
    description:
      "Discover insights about your future through ancient tarot wisdom",
    duration: "60 minutes",
    price: 40,
    popular: true,
  ...
  },
  {
    ...
    description:
      "Find the perfect date for your special day using cosmic alignment",
    duration: "30 minutes",
    price: 50,
    popular: false,
          ...
          {step === 2 && (
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Choose when you'd like to begin your spiritual journey
                </p>
              </div>
